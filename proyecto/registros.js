...
function leerBddPromesa() {
    return new Promise((resolve) => {
        fs.readFile(nombreBdd, 'utf-8', (error, contenLeido) => {
            if (error) {
                resolve({
...
function crearBdd() {
    ...
    return new Promise((resolve, reject) => {
        fs.writeFile(nombreBdd, base, (err) => {
            if (err) {
...
function eliminarPaciente(nombre) {
    // @ts-ignore
    return new Promise((resolve, reject) => {
        fs.readFile(nombreBdd, 'utf-8', (error, contenidoLeido) => {
            if (error) {
...
function guardarBase(bdd) {
    return new Promise((resolve, reject) => {
        fs.writeFile(nombreBdd, JSON.stringify(bdd, null, 2), (error) => {
            if (error) {
